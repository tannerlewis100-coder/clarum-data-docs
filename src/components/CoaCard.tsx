...
export default function CoaCard({ name, form, coa, compact }: CoaCardProps) {
  if (compact) {
    return (
  ...
  return (
    <div className="bg-card rounded-card border border-border overflow-hidden hover:border-gold/30 hover:shadow-[0_8px_30px_-8px_hsl(38_55%_52%/0.15)] transition-all duration-300">
      ...
      <div className="px-5 pb-5">
        <button className="w-full bg-emerald-500 hover:bg-emerald-600 text-primary-foreground text-xs font-body font-semibold py-3 rounded-lg transition-colors flex items-center justify-center gap-2 uppercase tracking-wider">
