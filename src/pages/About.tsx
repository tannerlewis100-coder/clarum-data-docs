    ...
    <div ref={revealRef}>
      ...
      <section className="relative bg-navy overflow-hidden pt-32 pb-24 border-b border-white/[0.03]">
        ...
        <div className="relative container mx-auto px-4 lg:px-8 max-w-3xl text-center">
          ...
          <h1 className="text-4xl lg:text-5xl xl:text-6xl font-display text-white leading-[1.1] mb-6">
          ...
          <p className="text-white/45 font-body leading-relaxed text-lg max-w-2xl mx-auto">
      ...
      {/* Story */}
      <section className="relative py-24 lg:py-32 bg-navy-alt overflow-hidden border-b border-white/[0.03]">
        ...
        <div className="relative container mx-auto px-4 lg:px-8 max-w-3xl">
          <div className="reveal">
            ...
            <h2 className="text-3xl lg:text-4xl font-display text-white mb-8 leading-tight">
              An industry that stopped caring about the people it served.
            </h2>
            <div className="space-y-5 text-white/50 font-body leading-[1.8]">
              <p>
      ...
      {/* Testing */}
      <section id="testing" className="py-20 bg-navy gold-grid-texture border-b border-white/[0.03]">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="text-center mb-14 reveal">
            <span className="text-xs uppercase tracking-[0.2em] text-gold font-body font-semibold">Methodology</span>
            <h2 className="text-3xl lg:text-4xl font-display text-white mt-2">5-Panel Testing Standard</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 reveal">
            {[
              ...
              <div key={c.title} className="text-center group">
                <div className="w-14 h-14 mx-auto mb-3 rounded-full border-2 border-gold/40 flex items-center justify-center group-hover:border-gold group-hover:shadow-[0_0_20px_-5px_hsl(40_50%_56%/0.3)] transition-all duration-300">
                  <c.icon className="h-6 w-6 text-gold" />
                </div>
                <h3 className="font-display text-lg text-white mb-1">{c.title}</h3>
                <p className="text-xs text-white/50 font-body">{c.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* Values */}
      <section className="py-20 bg-navy-alt border-b border-white/[0.03]">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="text-center mb-12 reveal">
            <span className="text-xs uppercase tracking-[0.2em] text-gold font-body font-semibold">Values</span>
            <h2 className="text-3xl lg:text-4xl font-display text-white mt-2">What We Stand For</h2>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 max-w-3xl mx-auto reveal">
            {values.map((v) => (
              <div key={v.title} className="bg-white/[0.03] rounded-2xl border border-white/[0.06] p-6 hover:border-gold/20 transition-colors">
                <h3 className="font-display text-xl text-white mb-2">{v.title}</h3>
                <p className="text-sm text-white/50 font-body">{v.desc}</p>
              </div>
            ))}
          </div>
